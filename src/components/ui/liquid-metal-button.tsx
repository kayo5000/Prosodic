...
export function LiquidMetalButton({
  ...
  const dimensions = useMemo(() => {
    ...
    if (viewMode === "icon") {
      ...
      const calcWidth = width ?? (label && label.length > 11 ? 180 : 142);
      return {
        width: calcWidth,
        height: h,
            ...
            {viewMode === "icon" && (
              <Sparkles
                ...
                style={{
                  ...
                  transition: "all 0.8s cubic-bezier(0.34, 1.56, 0.64, 1), color 0.3s ease",
                  transform: "scale(1)",
                }}
              />
            )}
            {viewMode === "text" && (
              <span
                style={{
                  ...
                  letterSpacing: "0.6px",
                  transition:
                    "all 0.8s cubic-bezier(0.34, 1.56, 0.64, 1), color 0.3s ease",
                  transform: "scale(1)",
                  whiteSpace: "nowrap",
                  userSelect: "none",
                  ...textStyle,

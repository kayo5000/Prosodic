...
/// Opens the app straight to the Osborne chat screen — see
/// mobile/src/navigators/linking.ts's DEEP_LINK_CHAT.
struct QuickChatIntent: AppIntent {
    static var title: LocalizedStringResource = "Ask Osborne"
    static var description = IntentDescription(
        "Opens Prosodic straight to an Osborne chat."
    )
...
struct ProsodicShortcuts: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        ...
        AppShortcut(
            ...
            phrases: [
                "Ask Osborne in \(.applicationName)",
                "Chat with Osborne in \(.applicationName)",
            ],
            shortTitle: "Ask Osborne",

...
- **Chat** (`src/screens/ChatScreen.tsx`) — Osborne (craft mentor), backed by `/veil/chat`.
...
Quick Write / Ask Osborne, wired via Expo config plugins. See
...
src/screens/ChatScreen.tsx           — Osborne chat screen
